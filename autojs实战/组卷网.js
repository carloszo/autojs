...
(function() {
    ...
    centerPrintButton.innerHTML =`<a class="download-btn" href="javascript:void 0">打印试卷</a>`
    ...
    // processButton.innerHTML = `<a href="javascript:void(0)" style="width:130px;" class="mr15"><i class="icon i-paper-07"></i><em class="m5 vm">打印试卷</em></a>`;
    ...
    var willAppendPlace = document.getElementsByClassName('global-ctrl')[0];
